...
#         "notes": "Prediction Complete",
#         "fertilizer_recommendation": "Check disease table."
#     }
#     print(label)
#     print(preds)
#     print(result)
...
# GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "AIzaSyA_xUe23TK_Es5UTwopiHzFDAg9CR8IS98")
# GOOGLE_MAPS_API_KEY = os.environ.get("GOOGLE_MAPS_API_KEY", "AIzaSyAOVYRIgupAurZup5y1PRh8Ismb1A3lLao")
...
# 2. Natural/organic treatment.
# 3. Chemical treatment (only generic names).
# 4. Preventive methods.

# Use simple English and no long paragraphs.
# """
#     try:
#         reply = gemini_model.generate_content(prompt)
#         return reply.text.strip()
#     except:
#         return "AI service not available right now. Please contact a local agriculture expert."
